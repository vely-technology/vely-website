...
export const metadata: Metadata = {
  title: "How to Delete Your Vely Account",
  description:
    "Steps to delete your Vely account in the app or by email, what data is removed, and how to cancel an Android subscription in Google Play.",
  alternates: { canonical: `${SITE_URL}/delete-account/` },
};

export default function DeleteAccountPage() {
  return <main id="main-content"><LegalPage title="Delete your Vely account" description="Account deletion is permanent. Review what happens, cancel any active subscription, and choose one of the request methods below.">
